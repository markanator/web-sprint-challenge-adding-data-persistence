...
-   SQL is the language used when dealing with relational Databases.
-   A relational database is a collection of information with defined relationships for easy access.

2. Why do tables need a `primary key`?

-   A PK ensures row-level accesibility, a unique value in each row

3.  What is the name given to a table column that references the primary key on another table.

-   A Foreign Key Reference, a link between two tables

4.  What do we need in order to have a _many to many_ relationship between two tables.

-   A join table, it contains PKs of the two tables it will join and perhaps some other data
